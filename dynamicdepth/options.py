...
class MonodepthOptions:
    def __init__(self):
        ...
        # options for cityscapes
        self.parser.add_argument('--train_cs', action='store_true')
          
        self.parser.add_argument('--plugin', action='store_true')
          
        self.parser.add_argument("--name", type=str, default="test")
        self.parser.add_argument("--tags", type=str, default="")
        ...
        self.parser.add_argument('--temporal', action='store_true')
        self.parser.add_argument('--main_temporal', action='store_true')
        ...
        self.parser.add_argument("--validate_from", type=int, default=0) 
        self.parser.add_argument('--saveoff', action='store_true')
        self.parser.add_argument("--save_until", type=int, default=0) 
        self.parser.add_argument('--debug', action='store_true')

        self.parser.add_argument('--tempv2', action='store_true')
        self.parser.add_argument('--no_ens', action='store_true')
        self.parser.add_argument('--eval_mode', action='store_true')
